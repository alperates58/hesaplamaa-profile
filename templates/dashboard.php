...
$result_explanations = array(
	...
	'bazal-metabolizma-hizi-hesaplama'     => 'Mifflin-St Jeor formülüyle hesaplanan tahmini bazal enerji ihtiyacıdır. Bilgilendirme amaçlıdır.',
	'dinlenme-metabolizma-hizi'            => 'Tam dinlenme halinde tahmini günlük kalori harcamasını gösterir. Bilgilendirme amaçlıdır.',
	'basit-kalori-ihtiyaci-hesaplama'      => 'Ağırlık bazlı kaba kalori tahminidir; bireysel metabolizma hesaba katılmamıştır. Bilgilendirme amaçlıdır.',
	'maksimum-nabiz-hesaplama'             => 'Fox (220-yaş) formülüyle hesaplanan tahmini maksimum nabız değeridir. Bilgilendirme amaçlıdır.',
	'hedef-nabiz-bolgesi-hesaplama'        => 'Maksimum nabzın yüzdelerine göre 5 egzersiz bölgesini gösterir. Bilgilendirme amaçlıdır.',
	'hedef-nabiz-hesaplama'                => 'Karvonen formülüyle hesaplanan hedef nabız değeridir. Bilgilendirme amaçlıdır.',
	'nabiz-bolgesi-hesaplama'              => 'Karvonen formülüyle 5 nabız bölgesini gösterir. Bilgilendirme amaçlıdır.',
	'venus-burcu-hesaplama'                => 'Venüs\'ün doğum gününüzdeki yörünge konumundan hesaplanan astrolojik tema göstergesidir.',
	'mars-burcu-hesaplama'                 => 'Mars\'ın doğum gününüzdeki yörünge konumundan hesaplanan astrolojik enerji temasını işaret eder.',
	'jupiter-burcu-hesaplama'              => 'Jüpiter burcunuz büyüme ve şans temasını işaret eder; sembolik referans olarak yorumlanabilir.',
